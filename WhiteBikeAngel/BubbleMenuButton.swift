...
protocol BubbleMenuViewDelegate:NSObjectProtocol{
    ...
    func bubbleMenuButtonDidExpand(expandableView:BubbleMenuButton)
    func bubbleMenuButtonWillCollapse(expandableView:BubbleMenuButton)
...
class BubbleMenuButton:UIView,UIGestureRecognizerDelegate{
    ...
    weak var delegate:BubbleMenuViewDelegate?
